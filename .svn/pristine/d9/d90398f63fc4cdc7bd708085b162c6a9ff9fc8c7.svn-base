...
import com.skl.cloud.controller.sub.dto.ResponseStatusSO;
import com.skl.cloud.foundation.mvc.model.ModelKeys;
import com.skl.cloud.foundation.mvc.model.SKLModel;

@Controller
public class SubController extends SKLController {

	 protected Logger log = LoggerFactory.getLogger(SubController.class);
	    ...
	    public void exceptionHandle(Exception ex, HttpServletRequest request, HttpServletResponse response) {
	        ...
	        try {
	            ...
	            ResponseStatusSO rs = new ResponseStatusSO(err.getCode(), err.getMsg());
